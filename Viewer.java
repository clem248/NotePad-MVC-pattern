...
public class Viewer {
    ...
    public void aboutProgram() {
        ...
        JLabel logoLabel = new JLabel(new ImageIcon(imagesDir + "O.jpg"));
        logoLabel.setBounds(90, 4, 60, 64);

        JLabel versionLabel = new JLabel("Intern Labs 5.0");
        ...
        String htmlText = "<html>" +
                ...
                "<br/><br/>" +
                "<strong>Intern Labs 5.0</strong> <br>" +
                "Version 1.0.0 <br/>" +
                "&#169; Intern Labs Corporation(Mediator Design Pattern). All rights <br/>" +
                "<br/><br/>" +
